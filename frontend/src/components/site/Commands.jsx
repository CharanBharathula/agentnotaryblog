...
const COMMANDS = [
  ...
  },
  {
    ...
    lines: [
      ...
      { p: "",  t: "probing   claude-sonnet-4.5 sha256:2d8e…11a0", c: "out" },
  ...
  },
  {
    ...
    lines: [
      ...
      { p: "",  t: "saved $89.42 vs uncapped baseline", c: "ok" },
    ],
  },
  {
    id: "attack",
  ...
  },
  {
    ...
    lines: [
      { p: "$", t: "agentnotary bench --models claude-sonnet-4-5,gpt-4o,gemini-2.5-flash", c: "cmd" },
      { p: "",  t: "  acc%", c: "out" },
      { p: "",  t: "100 ┤         ◆ claude-sonnet-4-5", c: "out" },
      { p: "",  t: " 90 ┤    ◆ gpt-4o", c: "out" },
  ...
  },
  {
    ...
    lines: [
      ...
      { p: "",  t: "diverge step 7 → live call claude-sonnet-4-5", c: "out" },
